...
<div style="clear:both;width:200px;margin-right:12px;" class="pull-right">
    <form action="index.php?p=sekolah&m=search">
        ...
        <input autocomplete="off" type="text" name="q" placeholder="Type and enter to search" value="<?php echo (get("q"));?>" class="search">
    </form>
</div>
...
<div style="clear:both">&nbsp;</div>
    ...
    ?>
        <tr>
            ...
            <td><a target="blank" href="proses/sekolah/pdf.php?id=<?php echo $key['id'];?>">PDF</a></td>
            <td><a href="proses/sekolah/download.php?id=10<?php echo $key['id'];?>">Download</a></td>
